...
def build_oss_config(flags: dict[str, str]) -> tuple[dict, dict[str, str]]:
    ...
    if "default_url" in llm_def and llm_def.get("base_url_key"):
        llm_config[llm_def["base_url_key"]] = flags.get("oss_llm_url") or llm_def["default_url"]
    ...
    if "default_url" in embedder_def and embedder_def.get("base_url_key"):
        embedder_config[embedder_def["base_url_key"]] = flags.get("oss_embedder_url") or embedder_def["default_url"]
